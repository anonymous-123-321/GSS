...
from .test import get_best_evaluation, evaluate_dataset_baseline
...
class MeanClassAccuracy(Metric):
    def __init__(self, model, dataset, dataloader,device, distance_fn, args):
    ...
    def __call__(self):
        ...
        evaluation = evaluate_dataset_baseline(dataset=self.dataset,
