...
class UCFDataset(data.Dataset):
    def __init__(self, args, dataset_split,):
        ...
        self.text_pt = torch.load("/mnt/sdc/your_name/Dataset/UCF/GZSL_data/text_embedding.pt",
                                  map_location='cpu')
    ...
    def check_exist(self):
        self.train_file_path = Path("/mnt/sdc/your_name/Dataset/UCF/GZSL_data/stage_1_train.pt")
        self.trainval_file_path = Path("/mnt/sdc/your_name/Dataset/UCF/GZSL_data/stage_2_train.pt")
        self.val_file_path = Path("/mnt/sdc/your_name/Dataset/UCF/GZSL_data/stage_1_val.pt")
        self.test_file_path = Path("/mnt/sdc/your_name/Dataset/UCF/GZSL_data/stage_2_test.pt")
