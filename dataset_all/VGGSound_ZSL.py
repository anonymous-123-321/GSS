...
class VGGSoundDataset(data.Dataset):
    def __init__(self, args, dataset_split, ):
        ...
        self.text_pt = torch.load("/mnt/sdc/your_name/Dataset/VGGSound/GZSL_data/text_embedding.pt", map_location='cpu')
    ...
    def all_data(self): 
        ...
        return {
            ...
            "box_jpg": torch.stack(self.data_pt["video"]["box"])[classes_mask] if "train" in self.dataset_split else None,
            "box_wav":torch.stack(self.data_pt['audio']['box'])[classes_mask] if "train" in self.dataset_split else None,
    ...
    def check_exist(self):
        self.train_file_path = Path("/mnt/sdc/your_name/Dataset/VGGSound/GZSL_data/stage_1_train.pt")
        self.trainval_file_path = Path("/mnt/sdc/your_name/Dataset/VGGSound/GZSL_data/stage_2_train.pt")
        self.val_file_path = Path("/mnt/sdc/your_name/Dataset/VGGSound/GZSL_data/stage_1_val.pt")
        self.test_file_path = Path("/mnt/sdc/your_name/Dataset/VGGSound/GZSL_data/stage_2_test.pt")
